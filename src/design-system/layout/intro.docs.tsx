  ...
  description: [
    ...
    <Docs.Blockquote key="3">
      <Docs.Text>
        ...
        space scale (e.g. <Docs.Code>space="19px"</Docs.Code>) which helps
        reduce the amount of variation in our layouts. These are modeled as
        strings to make autocompletion easier and to allow for other naming
